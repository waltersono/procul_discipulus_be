        ...
        <div class="card-body login-card-body">
            ...
            <form method="post" action="{{ url('/login') }}">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button
                            class="btn btn border border-left-0"
                            type="button"
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-dark btn-block" id="btnLogin" style="background-color: #000d13;">Iniciar sessão</button>
                    </div>

                </div>
                <p class="orline mb-2">OU</p>
                <div class="form-group mb-2">
                    <a href="{{ route('password.request') }}" class="btn btn-outline-dark text-dark w-100">
                        Esqueci minha senha
                    </a>
                </div>
            </form>
