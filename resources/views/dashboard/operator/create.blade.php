...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header mb-3 pb-2 border-bottom">
                            <h3 class="page-title">Adicionar Operador do Sistema</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('operators.index') }}">Operadores</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="card" action="{{ route('operators.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title"><span>Dados do operador</span></h5>
                                </div>
                                <div class="col-12">
