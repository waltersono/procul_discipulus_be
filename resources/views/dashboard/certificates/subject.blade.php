...
<head>
    ...
    <title>Certificado da Disciplina</title>
    <style>
        body{
...
<body>
    <div class="title-box">
        <h1 style="text-transform: uppercase;">Certificado de Conclusão da Disciplina de {{$cerficate->subject}}</h1>
        <img src="{{public_path($cerficate->schoolPhoto)}}" alt="Escola" style="width: 50px;">
    </div>
    <div class="box">
        <p style="font-size: 1.25rem;">Programa de estudos online da {{$cerficate->schoolName}} no curso de {{$cerficate->course}} na disciplina {{$cerficate->subject}} concluido por</p> 
