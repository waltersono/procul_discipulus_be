...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="card" action="{{ route('courses.update', $course->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select  @error('university_id') is-invalid @enderror" name="university_id">
                                            <option selected disabled>Selecionar escola</option>
                                            @foreach($universities as $university)
                                            <option value="{{$university->id}}" {{ old('university_id') == $university->id || $course->university->id == $university->id ? "selected" :""}}>{{$university->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('university_id')
                                            <span class="invalid-feedback" role="alert">
